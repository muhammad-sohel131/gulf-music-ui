const Profile = () => {
    return (
        <div>
            <h1 className="text-xl pb-6">Artists Profile:</h1>
            ...
            <div className="p-2 border border-gray-200 rounded-md mt-2">
                ...
                <div className="mt-2">
                    <span className="w-full">Genre:</span>
                    <input type="text" className="border border-gray-200 p-2 rounded-md w-full mt-2" />
                </div>
            ...
            <div className="p-2 border border-gray-200 rounded-md mt-2">
                ...
                <div className="mt-2">
                    <span className="w-full">Musical Journey:</span>
                    <input type="text" className="border border-gray-200 p-2 rounded-md w-full mt-2" />
                </div>
            ...
            <h2 className="text-lg pb-4 pt-4">MP3 Audio:</h2>
            <div className="p-2 border border-gray-200 rounded-md mt-2">
                <div>
                    <span className="w-full">playable song:</span>
                    <input type="file" className="border border-gray-200 p-2 rounded-md w-full mt-2" />
                </div>
            </div>
